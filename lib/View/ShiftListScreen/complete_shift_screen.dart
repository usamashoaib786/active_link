...
class CompletedShiftList extends StatefulWidget {
  const CompletedShiftList({super.key});

  @override
  State<CompletedShiftList> createState() => _CompletedShiftListState();
}

class _CompletedShiftListState extends State<CompletedShiftList> {
  late AppDio dio;
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              AppText.appText("Status",
                                                  ...
                                                  textColor:
                                                      AppTheme.blackColor),
                                              AppButton.appButton("Completed",
                                                  height: 22,
                                                  textColor:
                                                      AppTheme.whiteColor,
                                                  width: 90,
                                                  backgroundColor:
                                                      const Color(0xff28B705))
                                            ],
                                          ),
                                          Row(
                                            mainAxisAlignment:
